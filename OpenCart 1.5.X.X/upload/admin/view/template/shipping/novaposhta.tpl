 	...
 	<div class="container-fluid">
    	...
    	<div class="panel panel-default">
      		<div class="panel-heading clearfix">
        		<h3 class="panel-title pull-left" style="padding-top: 9px;"><i class="fa fa-cog" aria-hidden="true"></i> <?php echo $text_settings; ?></h3>
				<select name="store_id" id="input-store_id" onchange="location.href = 'index.php?route=shipping/novaposhta&token=<?php echo $token; ?>&store_id=' + this.value;" class="form-control" style="display: inline; width: auto;">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab-global">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="image">
													<img src="<?php echo $thumb; ?>" alt="" id="thumb-logo" />
													<input type="hidden" name="novaposhta[image]" value="<?php echo $novaposhta['image']; ?>" id="logo" />
													<br />
													<a onclick="image_upload('logo', 'thumb-logo');"><i class="fa fa-folder-open-o" aria-hidden="true"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-logo').attr('src', '<?php echo $placeholder; ?>'); $('#logo').attr('value', '');"><i class="fa fa-eraser" aria-hidden="true"></i></a>
												</div>
											</div>
									...
									<div class="tab-pane" id="tab-poshtomat">
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-poshtomat_status-enabled"><span data-toggle="tooltip" title="<?php echo $help_method_status; ?>"><?php echo $entry_method_status; ?></span></label>
											<div class="col-sm-4">
												<div class="radio-switch">
													<?php if ($novaposhta['shipping_methods']['poshtomat']['status']) { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][status]" value="0" id="input-poshtomat_status-disabled">
													<label class="col-sm-4" for="input-poshtomat_status-enabled"><?php echo $text_disabled; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][status]" value="1" id="input-poshtomat_status-enabled" checked>
													<label class="col-sm-4" for="input-poshtomat_status-disabled"><?php echo $text_enabled; ?></label>
													<?php } else { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][status]" value="0" id="input-poshtomat_status-disabled" checked>
													<label class="col-sm-4" for="input-poshtomat_status-enabled"><?php echo $text_disabled; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][status]" value="1" id="input-poshtomat_status-enabled">
													<label class="col-sm-4" for="input-poshtomat_status-disabled"><?php echo $text_enabled; ?></label>
													<?php } ?>
												</div>
											</div>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-poshtomat_cost-enabled"><span data-toggle="tooltip" title="<?php echo $help_cost; ?>"><?php echo $entry_cost; ?></span></label>
											<div class="col-sm-2">
												<div class="radio-switch">
													<?php if ($novaposhta['shipping_methods']['poshtomat']['cost']) { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][cost]" value="0" id="input-poshtomat_cost-disabled">
													<label class="col-sm-4" for="input-poshtomat_cost-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][cost]" value="1" id="input-poshtomat_cost-enabled" checked>
													<label class="col-sm-4" for="input-poshtomat_cost-disabled"><?php echo $text_yes; ?></label>
													<?php } else { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][cost]" value="0" id="input-poshtomat_cost-disabled" checked>
													<label class="col-sm-4" for="input-poshtomat_cost-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][cost]" value="1" id="input-poshtomat_cost-enabled">
													<label class="col-sm-4" for="input-poshtomat_cost-disabled"><?php echo $text_yes; ?></label>
													<?php } ?>
												</div>
											</div>
											<label class="col-sm-2 control-label" for="input-poshtomat_api_calculation-enabled"><span data-toggle="tooltip" title="<?php echo $help_api_calculation; ?>"><?php echo $entry_api_calculation; ?></span></label>
											<div class="col-sm-2">
												<div class="radio-switch">
													<?php if ($novaposhta['shipping_methods']['poshtomat']['api_calculation']) { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][api_calculation]" value="0" id="input-poshtomat_api_calculation-disabled">
													<label class="col-sm-4" for="input-poshtomat_api_calculation-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][api_calculation]" value="1" id="input-poshtomat_api_calculation-enabled" checked>
													<label class="col-sm-4" for="input-poshtomat_api_calculation-disabled"><?php echo $text_yes; ?></label>
													<?php } else { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][api_calculation]" value="0" id="input-poshtomat_api_calculation-disabled" checked>
													<label class="col-sm-4" for="input-poshtomat_api_calculation-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][api_calculation]" value="1" id="input-poshtomat_api_calculation-enabled">
													<label class="col-sm-4" for="input-poshtomat_api_calculation-disabled"><?php echo $text_yes; ?></label>
													<?php } ?>
												</div>
											</div>
											<label class="col-sm-2 control-label" for="input-poshtomat_tariff_calculation-enabled"><span data-toggle="tooltip" title="<?php echo $help_tariff_calculation; ?>"><?php echo $entry_tariff_calculation; ?></span></label>
											<div class="col-sm-2">
												<div class="radio-switch">
													<?php if ($novaposhta['shipping_methods']['poshtomat']['tariff_calculation']) { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][tariff_calculation]" value="0" id="input-poshtomat_tariff_calculation-disabled">
													<label class="col-sm-4" for="input-poshtomat_tariff_calculation-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][tariff_calculation]" value="1" id="input-poshtomat_tariff_calculation-enabled" checked>
													<label class="col-sm-4" for="input-poshtomat_tariff_calculation-disabled"><?php echo $text_yes; ?></label>
													<?php } else { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][tariff_calculation]" value="0" id="input-poshtomat_tariff_calculation-disabled" checked>
													<label class="col-sm-4" for="input-poshtomat_tariff_calculation-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][tariff_calculation]" value="1" id="input-poshtomat_tariff_calculation-enabled">
													<label class="col-sm-4" for="input-poshtomat_tariff_calculation-disabled"><?php echo $text_yes; ?></label>
													<?php } ?>
												</div>
											</div>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-poshtomat_delivery_period-enabled"><span data-toggle="tooltip" title="<?php echo $help_delivery_period; ?>"><?php echo $entry_delivery_period; ?></span></label>
											<div class="col-sm-2">
												<div class="radio-switch">
													<?php if ($novaposhta['shipping_methods']['poshtomat']['delivery_period']) { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][delivery_period]" value="0" id="input-poshtomat_delivery_period-disabled">
													<label class="col-sm-4" for="input-poshtomat_delivery_period-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][delivery_period]" value="1" id="input-poshtomat_delivery_period-enabled" checked>
													<label class="col-sm-4" for="input-poshtomat_delivery_period-disabled"><?php echo $text_yes; ?></label>
													<?php } else { ?>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][delivery_period]" value="0" id="input-poshtomat_delivery_period-disabled" checked>
													<label class="col-sm-4" for="input-poshtomat_delivery_period-enabled"><?php echo $text_no; ?></label>
													<input type="radio" name="novaposhta[shipping_methods][poshtomat][delivery_period]" value="1" id="input-poshtomat_delivery_period-enabled">
													<label class="col-sm-4" for="input-poshtomat_delivery_period-disabled"><?php echo $text_yes; ?></label>
													<?php } ?>
												</div>
											</div>
						...
						<div class="tab-pane fade" id="tab-tariffs">
              						...
              						<tbody>
                						<tr>
                  							...
                  							<td class="text-center">
                  								<a onclick="update('areas');" id="button-update_areas" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="<?php echo $button_update; ?>"><i class="fa fa-refresh"></i></a>
                  							</td>
               			 				</tr>
               			 				<tr>
               			 				...
               			 				<tr>
                  							...
                  							<td class="text-center">
                  								<a onclick="update('warehouses');" id="button-update_warehouses" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="<?php echo $button_update; ?>"><i class="fa fa-refresh"></i></a>
                  							</td>
               			 				</tr>
               			 				<tr>
          				...
          				<div class="tab-pane fade" id="tab-payment">
          					<div class="form-group">
            					...
            					<div class="col-sm-10">
            						<select name="novaposhta[delivery_payer]" id="input-delivery_payer" class="form-control">
										<option value="0"><?php echo $text_select; ?></option>
					        ...
					        <div class="panel panel-default">
								...
								<div class="table-responsive">
					            	<table class="table table-bordered table-hover" id="table-tracking_statuses">
										...
										<tr>
											<td>
												<select name="novaposhta[settings_tracking_statuses][<?php echo $c; ?>][shipment_statuses]" class="form-control">
													<?php foreach ($document_statuses as $document_status) { ?>
													<?php if ($document_status['StatusId'] == $settings['shipment_statuses']) { ?>
...
<script type="text/javascript"><!--
		...
		$.ajax( {
			...
			success: function (data, textStatus, jqXHR) {
				...
				if ($data.find('div.alert-danger').length) {
					...
					if (type === 'exit') {
						location.href = 'index.php?route=extension/shipping&token=<?php echo $token; ?>';
					}
				}
	...
	function settings(type) {
		...
		if (type == 'basic') {
			$.ajax( {
				url: 'index.php?route=shipping/novaposhta/extensionSettings&token=<?php echo $token; ?>&type=' + type,
				type: 'GET',
				dataType: 'json',
			...
			location.href = 'index.php?route=shipping/novaposhta/extensionSettings&token=<?php echo $token; ?>&type=' + type;
		} else if (type == 'import') {
	...
	function formHandler(element) {
		switch (element.id) {
			case 'input-key_api':
				...
				function action(act) {
					$.ajax( {
						url: 'index.php?route=shipping/novaposhta/verifyingAPIaccess&token=<?php echo $token; ?>',
						type: 'POST',
			...
			case 'input-poshtomat_cost-enabled':
			case 'input-poshtomat_cost-disabled':
	...
	function addTrackingStatus() {
		...
		row += '<td><select name="novaposhta[settings_tracking_statuses][' + count + '][shipment_statuses]" class="form-control"><?php foreach ($document_statuses as $document_status) { ?><option value="<?php echo $document_status['StatusId']; ?>"><?php echo $document_status['Description']; ?></option><?php } ?></select></td>';
	...
	$(function() {
		...
		$('input[id^="input-warehouse_cost"]:checked, input[id^="input-doors_cost"]:checked, input[id^="input-poshtomat_cost"]:checked, input[id^="input-autodetection_departure_type"]:checked, input[id^="input-calculate_volume"]:checked, input[id^="input-pack"]:checked, #input-money_transfer_method, #input-print_format, #input-template_type, #input-print_type').each(function() {
			formHandler(this);
		} );
		...
		// Search city
		$('#input-sender_city_name').autocompleteOM( {
		...
		// Search address
		$('#input-sender_address_name').autocompleteOM( {
			source: function(request, response) {
		...
		// Search recipient
		$('#input-recipient_name').autocompleteOM( {
			source: function(request, response) {
				$.ajax( {
					url: 'index.php?route=shipping/novaposhta/autocomplete&token=<?php echo $token; ?>',
					type: 'POST',
		...
		$('#input-departure_description').autocompleteOM({
			source: function(request, response) {
