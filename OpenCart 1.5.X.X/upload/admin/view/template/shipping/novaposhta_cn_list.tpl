			...
			<div class="pull-right">
				<div class="btn-group">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="<?php echo $print_markings_zebra_100_100_pdf; ?>" target="_blank" id="button-pdf-mz100x100"><?php echo $text_mark_zebra_100_100; ?></a></li>
						...
						<li><a href="<?php echo $print_markings_zebra_100_100_html; ?>" target="_blank" id="button-html-mz100x100"><?php echo $text_mark_zebra_100_100; ?></a></li>
						<li role="separator" class="divider"></li>
				...
				<div class="well">
					...
					<div class="row">
						<div class="form-group">
							<div class="col-sm-4 col-sm-offset-8" style="padding-top: 5px;">
											...
											<td class="text-center">
												<div class="btn-group">
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														<li><a href="<?php echo $print_markings_zebra_100_100_pdf, '/orders[]/', $cn['IntDocNumber']; ?>" target="_blank"><?php echo $text_mark_zebra_100_100; ?></a></li>
														<li role="separator" class="divider"></li>
														<li class="dropdown-header"><i class="fa fa-print fa-fw"></i> <?php echo $text_print_html; ?></li>
														...
														<li><a href="<?php echo $print_markings_zebra_100_100_html, '/orders[]/', $cn['IntDocNumber']; ?>" target="_blank"><?php echo $text_mark_zebra_100_100; ?></a></li>
													</ul>
												</div>
												<div class="btn-group">
...
<script type="text/javascript"><!--
	function assignmentOrder(number, ref) {
		if ($('#modal-assignment-order-to-cn').is(':hidden')) {
			...
			$.ajax( {
				url: 'index.php?route=shipping/novaposhta/addCNToOrder&token=<?php echo $token; ?>',
				type: 'POST',
				data: post_data,
				dataType: 'json',
				beforeSend: function () {
	...
	function deleteCN(self) {
		...
		$.ajax( {
			type: 'POST',
			url: 'index.php?route=shipping/novaposhta/deleteCN&token=<?php echo $token; ?>',
			data: post_data,
			dataType: 'json',
			beforeSend: function () {
	...
	$(function() {
		...
		$('#button-filter').on('click', function() {
			var
				url = 'index.php?route=shipping/novaposhta/getCNList&token=<?php echo $token; ?>',
